...
public class AudioManegerScript : MonoBehaviour {
	...
	void Start () {
		...
		playerAudio = player.transform.Find ("Player Audio").gameObject;


		//Audio Sources
		playerAudioSource = playerAudio.AddComponent<AudioSource> ();
...
/*	public void AdjustVolumes() {	//	Fade in and out for audios
	...
	*/
	...
	public void PlaySong(AudioClip clip){
		playerAudioSource.PlayOneShot(clip, 0.25f);
	}
}
